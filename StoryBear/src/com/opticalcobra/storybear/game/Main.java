...
//		story = "Münze Apfel Brot 1 2 3 4 5 ";
//		for (int i=1; i<7; i++){
//			story = story + story;
//		}
//		currentStory.setText(story);
...
//		story = "Brunnen Burg Hütte Haus Lebkuchenhaus Mühle Ofen Höhle Grube Mauer Turm Fahnen ";
//		for (int i=1; i<6; i++){
//			story = story + story;
//		}
//		currentStory.setText(story);
...
//		story = "Kutsche Schiff Wagen Boot Floß ";
//		for (int i=1; i<6; i++){
//			story = story + story;
//		}
//		currentStory.setText(story);
...
//		
//		
//		currentStory.setTitle("Rotkäppchen");
...
//		
//	
//		currentStory.setTitle("Lange Wörter Geschichte");
//		story = "Laaaaaaaaaaaaaaaaaaaaaaaange Wöööööööööööööööööööööööööööööööööööööööööööööööööööööööööööööööööörter siiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiind einfach vooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooll nervig! Das stimmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmt ihr mir alle zuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu, oder? ";
//		currentStory.setText(story);
//		db.insertStoryToDatabase(currentStory);
//		storyInfo = ta.analyzeText(currentStory);
//		db.insertStoryInfoToDatabase(storyInfo);
